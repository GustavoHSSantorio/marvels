package br.com.marvel.characters.list.data.model
...
data class MarvelCharacterDataContainer(
     var results: ArrayList<MarvelCharacter>? = null) : BaseModelMarvelContainer()
...
data class MarvelUrl(val type: String? = null,
                     val url: String? = null)
